  ...
  const DisplaySurveys = () => {
    ...
    if (surveys) {
      ...
      list = _.map(
        list,
        (
          { title, subject, body, yes, no, dateSent, lastResponded, _id },
          index
        ) => {
          return (
            <div key={dateSent} className="col s12 m6  survey-col">
              <div className="card horizontal ">
                <div className="card-stacked">
                  ...
                  <span
                    className="delete-survey-span"
                    onClick={() => handleDeleteSurvey(_id)}
                  >
                    <i className="tiny material-icons right delete-icon">
                      delete
                    </i>
                  </span>
                </div>
    ...
    <div className="dashboard">
      {noCredit ? (
        <div className="no-credit">
          <p>
            You don't have enough credit to send surveys, please buy credit
      ...
      <div className="container">
        {surveys.length ? (
          [
            ...
            <div className="row surveys-row" key='1'>
              <DisplaySurveys />
            </div>,
            <div className="overlay" key='2'>
              <LoadingOverlay
